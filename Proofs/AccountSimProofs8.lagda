...
module Proofs.AccountSimProofs8 where
...
initialImpliesMinting adr oref tn top record { inputVal = inputVal ; outputVal = outputVal ; outputDatum = (tok , l) ; signature = signature ; continues = continues ; inputRef = inputRef ; tokCurrSymbol = cs } ((TStart refl refl refl p4) , refl , refl , p7)
